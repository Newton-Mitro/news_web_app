        ...
        >
            ...
            <div className="p-2 lg:p-4">
                <div className="w-full border">
                    <div className="bg-surface shadow-sm overflow-hidden">
                                ...
                                <div className="flex-1 space-y-2">
                                    ...
                                    <div className="">
                                        <div className="flex gap-2">
                                            <button
                                                className="bg-primary text-onPrimary hover:bg-primaryVariant disabled:bg-disabled border hover:shadow-md transition-all duration-300 shadow-sm rounded py-1.5 px-1.5 md:px-4 hover:cursor-pointer"
                                            >
                                        ...
                                        <div className="flex items-center my-1.5 gap-2 justify-end">
                                            <div className="flex gap-10 items-center">
                                                <div className="flex items-center justify-end ">
                                                    <input
                                                        type="text"
                                                        className="w-full md:w-80 rounded-sm py-1 disabled:bg-disabled bg-transparent shadow-sm focus:ring focus:ring-primary focus:ring-opacity-20 text-onSurface"
                                                        onChange={(e) => {
                                                        }}
                                                    />
                                                    <button
                                                        className="border border-primary text-onSecondary disabled:bg-disabled hover:bg-secondaryVariant rounded-r bg-secondary px-2 py-1"
                                                    >
                                    ...
                                    {/*Table*/}
                                    <div
                                        className={`h-[calc(100vh-345px)] md:h-[calc(100vh-350px)] overflow-auto border border-b`}
                                    >
                                        <table
                                            className="whitespace-no-wrap relative w-full table-auto border-collapse">
                                            <thead className="w-full bg-secondary/10">
                                            <tr className="sticky -top-1 h-10 hidden w-full shadow-sm md:table-row bg-accent divide-x">
                                            ...
                                            <tr
                                                className="flex w-full flex-col flex-wrap divide-x border border-b even:bg-secondary/50 md:table-row"
                                            >
                                                <td className="px-2">
                                  ...
                                  <span
                                    ...
                                    <div className="mt-auto flex justify-between items-center">
                                        <div className="flex items-center gap-2">
                                            <select
                                                className="py-0.5 w-20 border border-borderColor shadow-sm focus:ring focus:ring-primary/10"
                                                name="limit"
                                                id="limit"
                                                value={10}
                                                onChange={(e) => {
